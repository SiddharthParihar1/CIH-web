    ...
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        ...
        <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
          🚀 Get Ready for an Action-Packed 12-Hour Hackathon! 🖥️💡
        </p>
      </div>
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        ...
        <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
          <BentoCard
            ...
            description="  Coding Begins – Let the innovation flow!"
          />
        </BentoTilt>
        ...
        <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
          <BentoCard
            ...
            description=" Break Time – Recharge for the second half!"
          />
        </BentoTilt>
        ...
        <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
          <BentoCard
            ...
            description="   Final Coding Sprint – Push your limits!"
          />
        </BentoTilt>
        ...
        <BentoTilt className="bento-tilt_2">
          <BentoCard
            src="/img/feature-4.jpg" // Change this to your image file
            title="8:00 PM:"
            description=" Prize Distribution – Celebrate your success!"
          />
        </BentoTilt>
      </div>
    </div>
